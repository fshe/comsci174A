...
triangle.prototype.populate = function()
{
 ...
 this.normals.push( vec3(0,0,1), vec3(0,0,1), vec3(1,0,0) );
...
inherit(octagon, shape);

octagon.prototype.populate = function(points_transform)
{

 this.vertices.push(vec3(0,0,0), vec3(-0.5,1,0), vec3(0.5,1,0));
 this.vertices.push(vec3(0,0,0), vec3(0.5,1,0), vec3(1,0.5,0));
 this.vertices.push(vec3(0,0,0), vec3(1,0.5,0), vec3(1,-0.5,0));
 this.vertices.push(vec3(0,0,0), vec3(1,-0.5,0), vec3(0.5,-1,0));
 this.vertices.push(vec3(0,0,0), vec3(0.5,-1,0), vec3(-0.5,-1,0));
 this.vertices.push(vec3(0,0,0), vec3(-0.5,-1,0), vec3(-1,-0.5,0));
 this.vertices.push(vec3(0,0,0), vec3(-1,-0.5,0), vec3(-1,0.5,0));
 this.vertices.push(vec3(0,0,0), vec3(-1,0.5,0), vec3(-0.5,1,0));

 this.texture_coords.push(vec2(0.5,0.5), vec2(0.25,1), vec2(0.75,1));
 this.texture_coords.push(vec2(0.5,0.5), vec2(0.75,1), vec2(1,0.75));
 this.texture_coords.push(vec2(0.5,0.5), vec2(1,0.75), vec2(1,0.25));
 this.texture_coords.push(vec2(0.5,0.5), vec2(1,0.25), vec2(0.75,0));
 this.texture_coords.push(vec2(0.5,0.5), vec2(0.75,0), vec2(0.25,0));
 this.texture_coords.push(vec2(0.5,0.5), vec2(0.25,0), vec2(0,0.25));
 this.texture_coords.push(vec2(0.5,0.5), vec2(0,0.25), vec2(0,0.75));
 this.texture_coords.push(vec2(0.5,0.5), vec2(0,0.75), vec2(0.25,1));
...
inherit(carShape, shape);

carShape.prototype.populate = function(points_transform)
{
 this.vertices.push(vec3(2,0,1), 
 					vec3(2,0,-1), 
 					vec3(-2,0,1),
 					vec3(-2,0,-1), 
 					vec3(1.5,1,0.5), 
 ...
 this.normals.push(vec3(0,0,1), vec3(0,0,-1) ,vec3(0,0,1) ,vec3(0,0,-1), vec3(0,1,0),vec3(0,1,0) ,vec3(0,-1,0) ,vec3(0,-1,0));
 //this.texture_coords.push(  vec3(0.5,2,1), vec3(1.5,2,1),
 	//			vec3(2,1.5,1), vec3(2,0.5,1), vec3(1.5,0,1), vec3(0.5,0,1), vec3(0,0.5,1), vec3(0,1.5,1) );
 //this.texture_coords.push( vec2(0.25,0.75), vec2(0.75,0.25), vec2(0.75,0.75),vec2(0.5,0.5),vec2(0.5,0), vec2(0.5,1), vec2(0,0.5), vec2(1,0.5), vec2(0.25,0.25) );
 this.texture_coords.push( vec2(0.25,0.75), vec2(0.75,0.25), vec2(0.75,0.75),vec2(0.5,0.5),vec2(0.5,0), vec2(0.5,1), vec2(0,0.5), vec2(1,0.5), vec2(0.25,0.25) );

 this.indices.push( 0,2,3, 0,1,3,  0,4,1, 1,4,5,  4,5,6, 5,6,7,  2,6,7, 2,3,7, 0,2,6, 0,4,6, 1,3,7, 1,5, 7 );
//this.indices.push( 0,1,4,5, 0,2,3,4, 3,2,4,5,  );
 
};



function square() //custom shape
{
 shape.call(this); // Inherit class shape’s array members by calling parent constructor
 this.populate();
 this.init_buffers(); // Send arrays to the graphics card into new buffers
...
{
 this.vertices.push(vec3(0,0,0), vec3(0,1,0), vec3(1,1,0), vec3(1,0,0) );
 this.normals.push(vec3(0,0,1),vec3(0,0,1) ,vec3(0,0,1) ,vec3(0,0,1)     );
 this.texture_coords.push( vec2(0,0), vec2(0,1), vec2(1,1), vec2(1,0) );
 this.indices.push( 0,1,2, 0,2,3 );
};



function circle() //custom shape
{
 shape.call(this); // Inherit class shape’s array members by calling parent constructor
 this.populate();
 this.init_buffers(); // Send arrays to the graphics card into new buffers
...
circle.prototype.populate = function()
{
 this.vertices.push(vec3(0,0,0),
 					vec3(1,0,0), vec3(0.866, 0.5,0),  vec3(0.5, 0.866,0),
 					vec3(0,1,0), vec3(-0.5, 0.866,0), vec3(-0.866, 0.5,0), 
 					vec3(-1,0,0), vec3(-0.866, -0.5,0),   vec3(-0.5, -0.866,0),
 					vec3(0,-1,0), vec3(0.5, -0.866,0),  vec3(0.866, -0.5,0)
 					);
 this.normals.push(
 					vec3(0,0,1), vec3(0,0,1),vec3(0,0,1) ,vec3(0,0,1) ,vec3(0,0,1),
 					vec3(0,0,1),vec3(0,0,1) ,vec3(0,0,1) ,vec3(0,0,1),
 					vec3(0,0,1),vec3(0,0,1) ,vec3(0,0,1) ,vec3(0,0,1)  );

 this.texture_coords.push( vec2(0.5,0.5), 
 							vec2(1,0.5), vec2(0.5+0.16,0.7), vec2(0.5+0.32,0.8), vec2(0.5 + 0.48,0.8), 
 							vec2(0.5,1), vec2(0.3,0.8), vec2(0.15,0.65), vec2(0.65,0.8), 
 							vec2(0,0.5), vec2(0.15, 0.35), vec2(0.3,0.2), vec2(0.65,0.8), 
 							vec2(0.5,0), vec2(0.65,0.2), vec2(0.8,0.35), vec2(0.65,0.8)  );
 ...
 this.indices.push( 
 	...
 	/*0,1,2, 0,2,3, 0,3,4, 0,4,5, 
 					...
 					0,7,8, 0,8,9, 0,9,10, 
 					0,10,11, 0,11,12, 0,12,1, 0,10,11, 0,11,12, 0,12,1);
};
